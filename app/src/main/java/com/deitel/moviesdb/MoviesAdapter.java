...
public class MoviesAdapter
         ...
         itemView.setOnClickListener(
            new View.OnClickListener() {
               ...
               public void onClick(View view) {
                  clickListener.onClick(DatabaseDescription.Movie.buildMovietUri(rowID));
               }
            }
         );
      }
   ...
   public void onBindViewHolder(ViewHolder holder, int position) {
      ...
      holder.setRowID(cursor.getLong(cursor.getColumnIndex(DatabaseDescription.Movie._ID)));
      holder.textView.setText(cursor.getString(cursor.getColumnIndex(
         DatabaseDescription.Movie.COLUMN_NAME)));
   }
